...
import {getMyCollectExamDetail, getShowCollect, collectCurrentQues, cancelCollectCurrentQues} from '@/api/index'
export default {
  directives: {
    TransferDom
  },
