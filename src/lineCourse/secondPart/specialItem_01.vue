  ...
  <div class="specialItem_info">
    ...
    <div class="specialItem_second">
      ...
      <div class="specialItem_second_third">
        ...
        <div class="specialItem_second_third_content">
          <div v-for="(item, index) in knowledgeList" :key="index" class="specialItem_each" @click="gotoKnowledeDetail(item)">
            <div class="serialNum"><span>{{index + 1}}</span></div>
...
<script>
import {getAllKnowledge} from '@/api/index'
export default {
  data () {
    return {
      chapterInfo: [], // 章节返回的信息
  ...
  methods: {
    ...
    //   }
    // },
    gotoKnowledeDetail (knowledgePoint) { // 点击知识点，跳转
      this.$router.push({
