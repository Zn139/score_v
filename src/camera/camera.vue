...
<!--    </label>-->
<!--&lt;!&ndash;    <uploader&ndash;&gt;-->
<!--&lt;!&ndash;      url="http://47.93.225.12:8081/upload.html"&ndash;&gt;-->
<!--&lt;!&ndash;    ></uploader>&ndash;&gt;-->
<!--&lt;!&ndash;    <x-button class="enter_submit" @click.native="submitCamera" >测试另一个相机</x-button> &lt;!&ndash;测试另一个相机&ndash;&gt;&ndash;&gt;-->
<!--  </div>-->
<!--</template>-->
<!--<script>-->
<!--export default {-->
