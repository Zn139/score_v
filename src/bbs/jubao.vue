<template>
  <div class="jubao-box">
    <div @click="openMenu" class="bbs-ope">
      <i class="iconfont icon_lulusandian2"></i>
      <Actionsheet
        v-model="showMenu"
        :menus="menu"
...
export default {
  ...
  methods: {
    ...
    sendRepBbs () {
      this.$axios({
        method: 'get',
        url: 'http://zhongkeruitong.top/show/cee/user/reportTake',
        params: {
          openid: this.openid,
    ...
    sendRepCom () {
      this.$axios({
        method: 'get',
        url: 'http://zhongkeruitong.top/show/cee/user/reportTakeInfo',
        params: {
          openid: this.openid,
          // openid: 'oMXOb1fL8RtRe67m4Uf_3EPsdimE',
    ...
    sendDelBbs () {
      this.$axios({
        method: 'get',
        url: 'http://zhongkeruitong.top/show/cee/user/deleteTake',
        params: {
          openid: this.openid,
          // openid: 'oMXOb1fL8RtRe67m4Uf_3EPsdimE',
          takeid: this.takeid
    ...
    sendDelCom: _.debounce(function (id) {
      this.$axios({
        method: 'get',
        url: 'http://zhongkeruitong.top/show/cee/user/deleteTakeInfo',
        params: {
          openid: this.openid,
          // openid: 'oMXOb1fL8RtRe67m4Uf_3EPsdimE',
          takeid: this.takeid,
