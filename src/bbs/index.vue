      ...
      <div class="bbs__add bbs_index">
        <div class="bbs-return return-box">
          ...
          <div class="bbs__add-btn" @click="gotoPage('bbsAdd')">
            <i class="iconfont icon_lulutianjia1"></i>
          </div>
        </div>
      </div>
      <bbs-tab
...
export default {
  ...
  methods: {
    ...
    getTimeList () {
      ...
      this.$axios({
        method: 'get',
        url: 'http://zhongkeruitong.top/show/cee/user/lookTakeByTime',
        params: {
          page: this.page,
          openid: this.openid
    ...
    getHotList () {
      ...
      this.$axios({
        method: 'get',
        url: 'http://zhongkeruitong.top/show/cee/user/lookTakeByHot',
        params: {
          page: this.page,
          openid: this.openid
          // openid: 'oMXOb1fL8RtRe67m4Uf_3EPsdimE'
...
<style lang="scss" scoped>
  ...
  .return-box .return__icon .iconfont {
    font-size: 18px;
    color: #fff;
  }
