  ...
  <div class="feedBack_info">
    ...
    <div class="feedBack_second" ref="aboutUs">
      <div class="statement_content">
        <p>乐学书僮应用尊重并保护所有使用服务用户的个人隐私权。为了给您提供更准确、更有个性化的服务，本应用会按照本隐私权政策的规定使用您的个人信息。本应用将以高度的勤勉、审慎义务对待这些信息。除本隐私权政策另有规定外，在未征得您事先许可的情况下，本应用不会将这些信息对外披露或向第三方提供。</p>
        <p>乐学书僮系统部分资源来自网络，如有侵犯个人版权，请联系我们删除对应资源。</p>
        <p style="font-weight: bold;font-size: 17px">免责声明详情细则</p>
        <p style="font-weight: bold">1. 适用范围</p>
        <p>a) 在您注册本应用帐号时，您根据本应用要求提供的个人注册信息；</p>
        <p>b) 在您使用本应用服务，或访问本应用平台时，本应用自动接收并记录的您的设备信息，包括但不限于您的IP地址、浏览器的类型、使用的语言、访问日期和时间、软硬件特征信息及您需求的网页记录等数据；</p>
        ...
        <p style="font-weight: bold">3. 信息披露</p>
        ...
        <p style="font-weight: bold">4. 信息存储和交换</p>
        <p>本应用收集的有关您的信息和资料将保存在本应用及（或）其关联公司的服务器上，这些信息和资料可能传送至您所在国家、地区或本应用收集信息和资料所在地的境外并在境外被访问、存储和展示。</p>

        <p style="font-weight: bold">5. Cookie的使用</p>
        <p>a) 在您未拒绝接受cookies的情况下，本应用会在您的使用应用设备上设定或取用cookies ，以便您能登录或使用依赖于cookies的本应用平台服务或功能。本应用使用cookies可为您提供更加周到的个性化服务，包括推广服务。</p>
        <p>b) 您有权选择接受或拒绝接受cookies。您可以通过修改设备设置的方式拒绝接受cookies。但如果您选择拒绝接受cookies，则您可能无法登录或使用依赖于cookies的本应用网络服务或功能。</p>
        <p>c) 通过本应用所设cookies所取得的有关信息，将适用本政策。

        <p style="font-weight: bold">6. 信息安全</p>
